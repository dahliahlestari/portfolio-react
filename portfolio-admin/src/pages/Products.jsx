...
export default function Products() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setShowModal(false)
            fetchProducts()
            setFormData({ title: "", slug: "", price: "", category: "Wedding Series 01", description: "", qrisData: "" })
            alert("Product added!")
        } catch (error) {
    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-10">
                <div>
                    <h2 className="text-3xl font-light mb-1">Products</h2>
                ...
                <div className="bg-white/5 border border-white/10 rounded-sm overflow-hidden backdrop-blur-sm">
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-white/5">
                            {products.length === 0 ? (
                                <tr>
                                    <td colSpan="4" className="px-6 py-8 text-center text-white/20 text-sm">No products found. Add one to get started.</td>
                                </tr>
                            ) : (
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
                    <div className="bg-[#0f0f11] border border-white/10 rounded-sm p-8 w-full max-w-lg h-[85vh] overflow-y-auto shadow-2xl">
                        <h3 className="text-xl font-light mb-6 border-b border-white/10 pb-4">Add New Product</h3>
